...
export default function ResearchPage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-white mb-1">Company Research</h1>
      ...
      <StepPageWrapper
        ...
        onApproved={(res) =>
          res?.needsClarification
            ...
            : router.push(`/projects/${projectId}/industry-priority`)
        }
      >
            ...
            <div className="space-y-5">
              ...
              {(cp.keyDifferentiators?.length > 0 || editMode) && (
                <div className="bg-slate-900 border border-white/10 rounded-xl p-5">
                  <h3 className="font-semibold text-white mb-3">Key Differentiators</h3>
                  <EditableList
              ...
              {(cp.currentCustomerExamples?.length > 0 || editMode) && (
                <div className="bg-slate-900 border border-white/10 rounded-xl p-5">
                  <h3 className="font-semibold text-white mb-3">Customer Examples</h3>
                  <EditableList
              ...
              {(cp.techStack?.length > 0 || editMode) && (
                <div className="bg-slate-900 border border-white/10 rounded-xl p-5">
                  <h3 className="font-semibold text-white mb-3">Tech Stack / Integrations</h3>
                  <EditableChips
                    items={cp.techStack ?? []}
